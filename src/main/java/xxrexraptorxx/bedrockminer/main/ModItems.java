...
public class ModItems {
    ...
    public static final RegistryObject<SwordItem> BEDROCK_SWORD = ITEMS.register("bedrock_sword", () ->
            new SwordItem(ToolMaterials.BEDROCK, 3, -2.4f, new Item.Properties().tab(CreativeTab.MOD_TAB)));
    public static final RegistryObject<PickaxeItem> BEDROCK_PICKAXE = ITEMS.register("bedrock_pickaxe",
            () -> new PickaxeItem(ToolMaterials.BEDROCK, 1, -2.8F, new Item.Properties().tab(CreativeTab.MOD_TAB)));
    public static final RegistryObject<AxeItem> BEDROCK_AXE = ITEMS.register("bedrock_axe",
            () -> new AxeItem(ToolMaterials.BEDROCK, 7.0F, -3.2F, new Item.Properties().tab(CreativeTab.MOD_TAB)));
    public static final RegistryObject<ShovelItem> BEDROCK_SHOVEL = ITEMS.register("bedrock_shovel",
            () -> new ShovelItem(ToolMaterials.BEDROCK, 1.5F, -3.0F, new Item.Properties().tab(CreativeTab.MOD_TAB)));
    public static final RegistryObject<HoeItem> BEDROCK_HOE = ITEMS.register("bedrock_hoe",
            () -> new HoeItem(ToolMaterials.BEDROCK,-2, -2.0F, new Item.Properties().tab(CreativeTab.MOD_TAB)){});
